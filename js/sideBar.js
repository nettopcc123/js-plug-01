(function() {
    function sideBar(opt) {
        this.version = '?v=' + (new Date()).valueOf(); //版本号
        this.common(); //公共配置
        this.initDom(); //dom构建
        this.i = 0; // 请求次数
    }
    ...
    sideBar.prototype.common = function() {
        ...
        this.baseUrl = 'https://77jsuser.78ymx.com'; // API接口地址
        this.kefuUrl = 'https://e-133432.chatnow.meiqia.com/dist/standalone.html'; //客服URL连接
        this.wechatEwm = 'https://images.82eev.com/sands_wechat.png'; //微信二维码图片
    ...
    sideBar.prototype.initDom = function() {
        var temp =
            '<link rel="stylesheet" href="https://images.82eev.com/hd/service_bar/css/app.css' + this.version + '">' +
